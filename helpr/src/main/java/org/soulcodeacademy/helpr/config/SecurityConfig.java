...
public class SecurityConfig {
    ...
    // authentication manager é a classe por trás de toda o gerenciamento da autenticação do usuário
    @Bean
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                .antMatchers(PUBLIC_ENDPOINTS).permitAll() // possibilita os endpoint no array serem públicos
